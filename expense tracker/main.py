...
expenses = []
selected_month = "All"
months = ["All","january","Febuary","March","April","May","June","July","August","September","October","November","December"]
...
def main(page : ft.Page):
    ...
    title = ft.Text("BizRise",size=32,weight=ft.FontWeight.BOLD, color=ft.Colors.CYAN) 
